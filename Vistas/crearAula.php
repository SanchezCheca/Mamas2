...
<body onload="cargar()">
    <div class="container-fluid principal p-0 m-0">
        ...
        <main class="row col-12 align-items-center justify-content-center p-4">
            ...
            <!-- Formulario aceptar -->
            <div class="row">
                <h1 class="w-100 text-center">Crear aula</h1>
                ...
                <!-- Caja para los alumnos a añadir -->
                <div class="col-12 col-lg-6" id="cajaCrear">
                    ...
                    <table class="table table-hover" id="tablaAlumnos">
                        ...
                        <tbody>
                            ...
                            foreach ($listaAlumnos as $o) {
                                ...
                                echo '<td>' . $o->correo . '</td>';
                                echo '<td>' . $o->nombre . '</td>';
                                //echo '<td><div class="bg-info text-light d-flex justify-content-center rounded annadir w-100">Añadir</div></td>';
                                echo '<td><button id="' . $o->id . '" onClick="anadir(this.id)" class="btn btn-info btn-sm" >Añadir</button></td>';
                                echo '</tr>';
                            }
                            ?>
                        </tbody>
                 ...
                 <!-- Caja para los alumnos ya añadidos -->
                 <div class="col-12 col-lg-6">
                    <h4>Alumnos añadidos</h4>
