    ...
    <div class="container-fluid principal p-0 m-0">
        <header class="row align-items-center navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar bg-primary">
            ...
            <div class="container">
                <div class="col-md-6">
                    <!-- Brand -->
                    <h3 class="font-weight-bold text-white">Asignar preguntas a "<?php echo $titulo ?>"</h3>
                </div>
                <div class="col-md-6">
                    <!-- Collapse -->
                ...
                <div class="row w-50 mx-auto d-flex justify-content-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="../Controladores/controladorPrincipal.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary w-100" name="addPregunta">Añadir</button>
                        </form>
                    </div>
