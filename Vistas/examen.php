        ...
        <main class="row col-12 align-items-center justify-content-center p-4">
            <div class="col-md-12">
                <form action="../Controladores/controladorCRUD.php" method="POST" name="anadir" class="row">
                    <button type="submit" name="anadirExamen" class="col-md-3 mx-auto btn btn-rounded btn-primary mb-5 marginmio"><i class="fas fa-plus pr-2" style="font-size: 20px" aria-hidden="true"></i>Crear Examen</button>
                    <button type="submit" name="crearPreguntas" class="col-md-3 mx-auto btn btn-rounded btn-primary mb-5 marginmio"><i class="fas fa-plus pr-2" style="font-size: 20px" aria-hidden="true"></i>Crear preguntas</button>
                </form>
            </div>
            <div class="col-md-12">
                <div class="row">
                            ...
                            <form action="../Controladores/controladorPrincipal.php" name="examen" method="POST" class="col-md-6">
                                <div class="card mt-5 mx-2 unique-color">
                                    <div class="card-header">
                                        <input type="hidden" name="idExamen" value="<?php echo $examenAux->getId(); ?>">
                                        ...
                                        ?>
                                            <select class="float-right" name="opcion" readonly>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="submit" class="btn btn-primary " name="asignarPreguntas"><i class="fas fa-plus pr-2" style="font-size: 20px" aria-hidden="true"></i>Asignar preguntas</button>
                                        <button type="submit" class="btn btn-primary" name="borrarExamen"><i class="fas fa-trash-alt pr-2" style="font-size: 20px" aria-hidden="true"></i>Borrar examen</button>
                                        <button type="submit" class="btn btn-primary" name="verExamen"><i class="fas fa-eye pr-2" style="font-size: 20px" aria-hidden="true"></i>Ver</button>
                                    </div>
                                </div>
                            </form>
                    <?php
