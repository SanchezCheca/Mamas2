    ...
    <div class="container-fluid principal p-0 m-0">
        ...
        <main class="row col-12 align-items-center justify-content-center p-4 d-flex">
            ...
            ?>
                ...
                ?>
                    <div class="col-12 col-sm-5 cuerpoTarjeta rounded p-2 m-2">
                        <div class="row">
                            <div class="col-12 cabeceraTarjeta">
                        ...
                        <form class="w-100 d-flex justify-content-center" name="verAula" action="../Controladores/controladorPrincipal.php" method="POST">
